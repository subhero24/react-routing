...
export default function Routes(
	config: any,
	options?: { base?: string; location?: string | URL; history?: History; document?: Document },
): (props: {
...
export function useHistory(): History & {
	navigate: (
		...
		options?: { sticky?: boolean; replace?: boolean; state?: any; title?: string },
	) => void;
};
export function useNavigate(): (
	path: string | null | undefined,
	options?: { sticky?: boolean | number; replace?: boolean; state?: any; title?: string },
) => void;
